		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "tuketici noktasi",
									"targetURL": "#noktasisorgulamatuketici-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"noktasisorgulamatuketici-display": {
								"semanticObject": "noktasisorgulamatuketici",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=noktasisorgulama.tuketici",
									"url": sap.ui.require.toUrl("noktasisorgulama/tuketici")
								}
							}
						}
					}
